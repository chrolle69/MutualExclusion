...
const (
	MutualExlusionService_AskPermission_FullMethodName = "/proto.MutualExlusionService/AskPermission"
)
...
func _MutualExlusionService_AskPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MutualExlusionService_AskPermission_FullMethodName,
	}
